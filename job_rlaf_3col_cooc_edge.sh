...
#SBATCH --mem=60G
#SBATCH -t 24:00:00
#SBATCH --output=slurm_rlaf_3col_cooc_edge_%j.out
#SBATCH --error=slurm_rlaf_3col_cooc_edge_%j.err
...
python -u train_arienet_rlaf.py \
    ...
    wandb.name=ArieNet_3col_COOCEdge
