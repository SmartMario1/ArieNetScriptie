#!/bin/bash
#SBATCH -J rlaf_3col_cooc_edge_cat
#SBATCH -p gpu_a100
#SBATCH -N 1
#SBATCH --ntasks=1
...
#SBATCH --mem=60G
#SBATCH -t 24:00:00
#SBATCH --output=slurm_rlaf_3col_cooc_edge_cat_%j.out
#SBATCH --error=slurm_rlaf_3col_cooc_edge_cat_%j.err
...
python -u train_arienet_rlaf.py \
    ...
    wandb.name=ArieNet_3col_COOCEdge_cat
