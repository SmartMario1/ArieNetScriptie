#!/bin/bash
#SBATCH -J rlaf_3col_cooc_edge_log
#SBATCH -p gpu_a100
#SBATCH -N 1
#SBATCH --ntasks=1
...
#SBATCH --mem=60G
#SBATCH -t 24:00:00
#SBATCH --output=slurm_rlaf_3col_cooc_edge_log_%j.out
#SBATCH --error=slurm_rlaf_3col_cooc_edge_log_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=YOUR_EMAIL@example.com

# ─── Snellius RLAF Training: ArieNetCoocEdge + symlog normalisation, glucose
# Identical to job_rlaf_3col_cooc_edge.sh except cooc_norm_mode=log.
# ──────────────────────────────────────────────────────────────────────────
...
python -u train_arienet_rlaf.py \
    ...
    wandb.name=ArieNet_3col_COOCEdge_log
