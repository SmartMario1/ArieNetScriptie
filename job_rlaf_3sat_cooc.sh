...
#SBATCH --mem=60G
#SBATCH -t 24:00:00
#SBATCH --output=slurm_rlaf_3sat_cooc_lse_%j.out
#SBATCH --error=slurm_rlaf_3sat_cooc_lse_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=YOUR_EMAIL@example.com

# ─── Snellius RLAF Training: ArieNetCooc (with COOC), 3-SAT ────────────────
...
python -u train_arienet_rlaf.py \
    ...
    wandb.name=ArieNet_3sat_COOC_lse
