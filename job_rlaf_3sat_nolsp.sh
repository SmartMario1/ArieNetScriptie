...
#SBATCH --mem=60G
#SBATCH -t 24:00:00
#SBATCH --output=slurm_rlaf_3sat_nolsp_%j.out
#SBATCH --error=slurm_rlaf_3sat_nolsp_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=YOUR_EMAIL@example.com

# ─── Snellius RLAF Training: no COOC, no local-satisfaction features, 3-SAT ─
# Same as job_rlaf_3sat.sh but with model.no_precomputed_local_sat=true.
