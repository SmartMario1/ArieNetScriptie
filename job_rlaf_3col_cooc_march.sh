...
#SBATCH --mem=60G
#SBATCH -t 24:00:00
#SBATCH --output=slurm_rlaf_3col_cooc_march_%j.out
#SBATCH --error=slurm_rlaf_3col_cooc_march_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=YOUR_EMAIL@example.com

# ─── Snellius RLAF Training: ArieNetCooc, march solver ─────────────────────
# Identical to job_rlaf_3col_cooc.sh except solver=march.
...
python -u train_arienet_rlaf.py \
    ...
    wandb.name=ArieNet_3col_COOC_march
