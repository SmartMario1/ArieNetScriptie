...
#SBATCH --mem=60G
#SBATCH -t 24:00:00
#SBATCH --output=slurm_rlaf_3sat_march_%j.out
#SBATCH --error=slurm_rlaf_3sat_march_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=YOUR_EMAIL@example.com

# ─── Snellius RLAF Training: ArieNet (no COOC), march solver, 3-SAT ────────
# Identical to job_rlaf_3sat.sh except solver=march.
