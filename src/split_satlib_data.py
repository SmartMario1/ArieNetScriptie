...
def main():
    ...
    total_train = len(split_idx['train'])
    for t, idx in enumerate(split_idx['train']):
        ...
        if (t + 1) % 100 == 0:
            print(f'Moved train file {t + 1}/{total_train}', end='\r')

    total_valid = len(split_idx['valid'])
    for t, idx in enumerate(split_idx['valid']):
        ...
        if (t + 1) % 100 == 0:
            print(f'Moved valid file {t + 1}/{total_valid}', end='\r')

    total_test = len(split_idx['test'])
    for t, idx in enumerate(split_idx['test']):
        ...
        if (t + 1) % 100 == 0:
            print(f'Moved test file {t + 1}/{total_test}', end='\r')
